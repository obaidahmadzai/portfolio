...
import contactImage from "../../public/profile.jpg";
...
function Contact() {
  return (
    <div
      id="contact"
      className="w-full lg:h-screen widescreen:section-min-height tallscreen:section-min-height scroll-mt-20"
    >
        ...
        <div className="grid lg:grid-cols-5 gap-8 ">
          ...
          <div className="cols-span-3 lg:col-span-2 w-full h-full shadow-xl shadow-gray-400 rounded-xl p-4 ">
            <div className="lg:p-4 h-full">
              ...
              <div>
                <p className="uppercase pt-0">Connect with me</p>
          ...
          <div className="col-span-3 w-full h-auto shadow-xl shadow-gray-400 rounded-xl lg:p-4 ">
            <div className="p-4">
              <form>
                ...
                <button className="w-full p-4 text-gray-100 mt-5">
                  Send Message
                </button>
              </form>
            </div>
